                    ...
                    <td align="right">
                    	<div class="ui-widget-content ui-corner-all" style="padding:25px 25px; margin: 5px;" align="center">
                            <table border="0" cellpadding="3">
                                ...
                                <tr>
                                    <td align="right"><label class="labelLogin">Servicio:</label></td>
                                    <td align="left"><select class="selectLogin" id="cbServicio"><option value="0">--Seleccione--</option></select></td>
                                </tr>
                                <tr>
                                    <td align="center" colspan="2">
                                        <button id="btnIndex" onClick="login()" >Iniciar Sesion</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
