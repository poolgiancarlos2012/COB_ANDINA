...
$pathfile="C:\xampp\htdocs\COB_ANDINA\documents\loadtelf\"; 		# definiendo la ruta donde lo archivos seran trabajados
...
bcp "SELECT 'COD_CLIENTE','TELEFONO' UNION SELECT RUC AS COD_CLIENTE,TELEFONO FROM RSFACCAR..BASE_CLIENTE WHERE TELEFONO<>'' " queryout $fileancii -c -T -w -U sa -P Andinars08; # exportando la BD a un .txt con caracter ansi
...
C:\xampp\php\php.exe -f C:\xampp\htdocs\COB_ANDINA\tarea\exportar_telf.php $namefile >> C:\xampp\htdocs\COB_ANDINA\tarea\exportar_telf.log