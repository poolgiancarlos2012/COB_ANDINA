...
<html>
    ...
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true&language=es&region=ES">
                        ...
                        <div id="cobrastHOME" style="background-color:#FFFFFF; width:100%; height:100%; ">
                            ...
                            <div id="panelMainHome" class="ui-widget-content" style="border:0 none;width:100%;height:100%;" align="center">
                                <table>
                                    <tr>
                                        <td align="center">
                                            <span class="textLogo">COBRAST</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <p class="textInfo">Sistema de gestion de cobranza</p>
                                            <p class="textInfo">Basado en una estrategia de negocio centrada en el cliente</p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
