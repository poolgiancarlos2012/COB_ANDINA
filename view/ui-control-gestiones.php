...
<script type="text/javascript" src="../js/ControlGestionDAO.js"  ></script>
<script type="text/javascript" src="../js/ControlGestionJQGRID.js"  ></script>
<script type="text/javascript" src="../js/js-control-gestion.js"  ></script>
<style type="text/css">
    .textLogo {
        font-size:100px;
        font-family:Verdana;
        ...
        <tr>
            <td class="barLayer">
                <div id="barLayer" style="width:210px; display:none; background:#fffbf2;border: 1px solid #666;margin:0;position:absolute;z-index:9999;height:100%;overflow:auto;" >
                    ...
                    <div id="panelMenu" class="backPanel contentBarLayer" style="display:block;" >
                        <div style="width:100%;">
                            <div style="margin-left:20px; margin-bottom:2px;"><a class="text-blue" onClick="_display_panel('panelControlGestionMain')">Home</a></div>
                        </div>       
                    </div>
                    <div class=" backPanel headerPanel">
            ...
            <td width="100%">	
                <div id="cobrastHOME" style="background-color:#FFFFFF; width:100%; height:100%; ">
                    ...
                    <div id="panelControlGestionMain" class="ui-widget-content" style="border:0 block;width:100%;height:100%;" align="center">
                        <table cellpadding="0" cellspacing="0" border="0" style="width:100%;" >
                            <tr>
                                <td>
                                    <div>
                                        <!--<div class="ui-widget-header ui-corner-top">Gestiones</div>
                                        <div style="overflow:auto;height:450px;">
                                                <table cellpadding="0" cellspacing="0" border="0" id="tbGestionesControlGestion"></table>
                                        </div>
                                        ...
                                        <table id="tableGestionesControlGestion" cellpadding="0" cellspacing="0" border="0"></table>
                                        <div id="pagerGestionesControlGestion"></div>
                                    </div>
                                </td>
                            </tr>
                        </table>
