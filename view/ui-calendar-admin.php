...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="../js/CalendarAdminDAO.js"  ></script>
        <script type="text/javascript" src="../js/js-calendar-admin.js"  ></script>
        <style type="text/css">
            .ui-selecting {  }
    ...
    <body>
                    ...
                    <td width="100%">	
                        <div id="cobrastHOME" style="background-color:#FFFFFF; width:100%; height:100%; ">
                            ...
                            <div id="panelAtencionEventosTareas" style="display:none;" align="center" class="ui-widget-content" >
                                <div onclick="_slide2(this,'content_table_eventos')">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                                        <tr>
                                ...
                                <div onclick="_slide2(this,'content_table_tarea')">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                                        <tr>
                                            <td style="width:25px; height:25px;">
        ...
        <div id="FormCalendar" style="display:none;width:auto;" class="FormCalendar ui-corner-all">
            ...
            <div style="background-color:#FFF;">
                <table>
                    <tr>
                        <td><button class="ui-state-active ui-corner-all" onclick="DisplaySubFormCalendar('SubFormCalendarEvent')">Evento</button></td>
                        <td><button class="ui-state-active ui-corner-all" onclick="DisplaySubFormCalendar('SubFormCalendarWork')">Tarea</button></td>
                ...
                <table id="SubFormCalendarEvent" style="display:block;width:100%;">
                    ...
                    <tr>
                        <td align="right"><label class="text-black" >Hora:</label></td>
                    ...
                    <tr>
                        <td colspan="2">
                            <div>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td align="center" class="ui-widget-header ui-corner-tl" style="width:30px;padding:2px 0px;" >&nbsp;</td>
                                        <td align="center" class="ui-widget-header" style="width:250px;padding:2px 0px;">Operador</td>
                                        <td align="center" class="ui-widget-header" style="width:30px;padding:2px 0px;"><input type="checkbox" onclick="check_all_table('table_operadores_evento',this.checked)" /></td>
                                        <td align="center" class="ui-widget-header ui-corner-tr" style="width:20px;padding:2px 0px;">&nbsp;</td>
                                    </tr>
                                </table>
                            </div>
                            <div style="overflow:auto;height:150px;">
                                <table cellpadding="0" cellspacing="0" border="0" id="table_operadores_evento"></table>
                            </div>
                            ...
                            <div>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td align="center" class="ui-widget-header ui-corner-tl" style="width:30px;padding:2px 0px;" >&nbsp;</td>
                                        <td align="center" class="ui-widget-header" style="width:250px;padding:2px 0px;">Operador</td>
                                        <td align="center" class="ui-widget-header" style="width:30px;padding:2px 0px;"><input type="checkbox" onclick="check_all_table('table_operadores_tarea',this.checked)" /></td>
                                        <td align="center" class="ui-widget-header ui-corner-tr" style="width:20px;padding:2px 0px;">&nbsp;</td>
                                    </tr>
                                </table>
                            </div>
                            <div style="overflow:auto;height:150px;">
                                <table cellpadding="0" cellspacing="0" border="0" id="table_operadores_tarea"></table>
                            </div>
                            <div style="height:20px;" class="ui-widget-header ui-corner-bottom"></div>
                        </td>
