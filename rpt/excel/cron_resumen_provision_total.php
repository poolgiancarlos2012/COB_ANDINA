<?php
    ...
    $carteras = "25229,25228,25227,25226,25225,25224,25223,25222,25221,25220";
...
*/
    ...
    $sqlCreateTemporaryFotoCarteraVisita= "CREATE TEMPORARY TABLE TMP_FOTOCARTERAVISITA_PROVISION_TOTAL
                    ...
                    --    statusCLIENTE TINYINT(4),
                      ...
                      --  idGestor varchar(40),
                      --  asignado varchar(40),
                       -- codigo_user varchar(40),
                    --    CODVISITA varchar(40),
    
                    */
                    /*despues de idcliente_cartera
                        --    GESTION varchar(40),
                    */
                    /*despues de peso
                    --    idcuenta varchar(40),
                    */
                    /*despues de codigo_cliente
                    --     NOMBRE_CLIENTE varchar(40),
                    --    DEUDA varchar(40),
                    --    FECHA_VISITA varchar(40),
                    */
                    /*despues de fecha_cpg
                     --   MONTO_CP varchar(40),
                     --   PARENTESCO varchar(40),
                     --   CONTACTO varchar(40),
                    --    NOMBRE_CONTACTO varchar(40),
                    --    MOTIVO_NO_PAGO varchar(40),
                    --    DIRECCION varchar(40),
                    --    DISTRITO varchar(40),
                    --    PROVINCIA varchar(40),
                    --    DEPARTAMENTO varchar(40),
                    */
                    /*despues de estado_visita
                        --    PRIORIDAD varchar(40),
                        --    GESTOR_CAMPO varchar(40),
                    */
                    /*(despues de observacion x seaca)
                    IDCLIENTE_CARTERA_UL_MOTNOPAGO varchar(40),
                        FECHA_VISITA_UL_MOTNOPAGO varchar(40),
                        CODIGO_CLIENTE_UL_MOTNOPAGO varchar(40),
                        UL_MOTIVO_NO_PAGO varchar(40),
    ...
    if($prCreateTemporaryFotoCarteraVisita->execute()){
                                        ...
                                        select * from (
                                            select * from (
                                               ...
                                               -- car.fecha_fin AS 'FECHA_FIN',
                                                ...
                                                (SELECT finser.peso from ca_final_servicio finser inner join ca_final fin on fin.idfinal=finser.idfinal where fin.idfinal= vis.idfinal limit 1) AS 'peso',
        ...
        $sqlCountCodClientesByLlamadas = "SELECT COUNT(*) AS 'COUNT' FROM (
                                            select  distinct CODIGO_CLIENTE AS CODIGO_CLIENTE  FROM (  -- DISTINTOS CODIGO_CLIENTES DE LLAMADAS
                                                    SELECT * FROM (
                                                        SELECT * FROM (
                                                            SELECT
                ...
                $sqlLlenarTemporaryVisita = "INSERT TMP_FOTOCARTERAVISITA_PROVISION_TOTAL (
                    ...
                    INNER JOIN( 
                        ...
                        LEFT JOIN (
                                ...
                                (select mot.nombre from ca_motivo_no_pago mot where mot.idmotivo_no_pago = vis.idmotivo_no_pago limit 1) AS 'UL_MOTIVO_NO_PAGO' 
                                from    ca_visita vis
                                inner join ca_cuenta cu on cu.idcuenta = vis.idcuenta
                        ...
                        LEFT JOIN( 
                            select * from (
                                select 
                               ( select  par.nombre  from ca_parentesco par where par.idparentesco = vis.idparentesco limit 1)AS 'TIPO_CONTACTO', vis.idcliente_cartera AS 'IDCLIENTE_CARTERA_UL_TIPO_CONTACTO', clicar.codigo_cliente AS 'CODIGO_CLIENTE_UL_TIPOCONTACTO', vis.fecha_visita AS 'FECHA_VISITA_UL_TIPOCONTACTO' 
                                from ca_visita vis
                                inner join ca_cuenta cu on cu.idcuenta = vis.idcuenta
                                inner join ca_cliente_cartera  clicar on clicar.idcliente_cartera = vis.idcliente_cartera
                                inner join ca_cartera car on car.idcartera= clicar.idcartera
                                                            ...
                                                            LEFT JOIN (
                                                                    ...
                                                                    select  *  FROM (  
                                                                        SELECT * FROM (
                                                                                        ...
                                                                                        CASE  WHEN ( DAYOFWEEK( lla.fecha )!= 2 and  DAYOFWEEK( lla.fecha )!=3  and  DAYOFWEEK( lla.fecha )!=4 )   THEN '3'
                                                                                            ...
                                                                                            ELSE 'B'
                                                                                        END AS 'FRECUENCIA',    
                                                                                            lla.idfinal,(select finser.peso from ca_final_servicio finser where  finser.idfinal=lla.idfinal limit 1) AS 'peso',
                                                                    ...
                                                                    LEFT JOIN (
                                                                        select * from ( -- 270
                                                                            ...
                                                                            (select mot.nombre from ca_motivo_no_pago mot where mot.idmotivo_no_pago = lla.idmotivo_no_pago limit 1) AS 'UL_MOTIVO_NO_PAGO' 
                                                                            from ca_llamada lla 
                                                                            inner join ca_cuenta cu on cu.idcuenta = lla.idcuenta
                                                                    ...
                                                                    LEFT JOIN ( 
                                                                            select * from (  -- 67
                                                                            select lla.idcliente_cartera as 'IDCLIENTE_CARTERA_UL_TIPOCOBRANZA',clicar.codigo_cliente AS 'CODIGO_CLIENTE_UL_TIPOCOBRANZA', (select par.nombre from ca_parentesco par where par.idparentesco=lla.idparentesco limit 1) AS 'NOMBRE_UL_TIPO_COBRANZA', lla.fecha AS 'FECHA_UL_TIPO_COBRANZA' 
                                                                            FROM ca_cartera car 
                                                                            INNER JOIN ca_cliente_cartera clicar ON clicar.idcartera=car.idcartera
                                                                            INNER JOIN ca_cliente cli ON clicar.idcliente = cli.idcliente 
                                                                            INNER JOIN ca_llamada lla ON lla.idcliente_cartera = clicar.idcliente_cartera
