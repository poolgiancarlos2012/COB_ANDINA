<?php
    ...
    header("Content-Disposition:atachment;filename=visita_opcion.xls");
    ...
    cu.tramo_cuenta AS 'NRO_CUOTA',
    cu.telefono AS 'FECHA_VENCIMIENTO',
    DATEDIFF(DATE(NOW()),DATE(cu.telefono)) AS 'DIAS_MORA',
    ...
    ELSE '' END AS 'TIPO',
    IF(CONCAT_WS(' ',TRIM(cli.nombre),TRIM(cli.paterno),TRIM(cli.materno))<>'',CONCAT_WS(' ',TRIM(cli.nombre),TRIM(cli.paterno),TRIM(cli.materno)),cli.razon_social) AS 'NOMBRE_TITULAR',           
