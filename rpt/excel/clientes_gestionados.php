<?php
	...
	header("Content-Disposition: attachment; filename=clientes_gestionados.xls");
	header("Expires: 0");
	...
	?>
    	<table>
        	<tr>
            	<td colspan="2" style="font-weight:bold;font-size:24px;">REPORTE DE CLIENTES GESTIONADOS</td>
            </tr>
            <tr>
