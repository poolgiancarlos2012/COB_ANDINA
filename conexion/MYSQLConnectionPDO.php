    ...
    public function getConnection( $user = "", $password = "", $new_config = NULL ) {
        ...
        try {
            if (self::$connecion == NULL) {
                ...
                self::$connecion = new PDO($cf->getDns(), $cf->getUser(), $cf->getPassword(), array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8", PDO::ATTR_PERSISTENT => true,PDO::MYSQL_ATTR_LOCAL_INFILE => true));
