...
//~ BBVA
    ...
    if($('#cboReporte').val() == '97' || $('#cboReporte').val() == '122' || $('#cboReporte').val() == '98' || $('#cboReporte').val() == '99' || $('#cboReporte').val() == '109' || $('#cboReporte').val() == '127')
    {
